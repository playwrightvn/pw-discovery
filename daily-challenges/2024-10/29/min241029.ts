...
function calculateTotalDrinks(initialBottles) {
    let total = initialBottles
    let empty = initialBottles
    while (empty >= 3) {
      const newDrinks = Math.floor(empty / 3)
      total += newDrinks
      empty = empty % 3 + newDrinks
...
console.log(calculateTotalDrinks(13))